...
配線作業は変態度数ではT氏の数倍先を行くJP氏が手伝ってくれて順調に完了。JP氏が配線の仕上げをしてくれているうちに、EPSに設置したRTX1200にプロバイダー情報を入れてネットの接続を開始した。

原島君からwifiの立ち上げを急かされていたのでEPS付近でひとまずのAPを起動させた。(wifiを求めていたスタッフが続々と接続を開始)
...
ビンゴ! 中央EPSから伸びたLANケーブルが来ていて、更に別室へのLANケーブルもボックス内にある。これを接続すればいけるはず!
...
「なんすかねー」と遺言を残し、サタンJPは旅立っていった。一人残されたT氏は再度LANケーブルのラベルを確認する。「B1ST-1って何なんだよ・・・」この時点でほぼ諦めかけていた。
...
あった!! **控え室1** **控え室2** **控え室3** とラベリングしてあるLANケーブルがあった! (小躍りするT氏とJP氏)
...
おいおい、ラベリングすら間違ってるのかよ・・・。**控室3**を挿すと「控え室1」に繋がる。何を言ってるのか分からないけど、まぁ大田区ルールなのだろう。
...
「控え室1」にはCiscoのMerakiを設置。ここを経由してとき宣メンバーとスタッフさんに専用wifiを使ってもらうことができた。
